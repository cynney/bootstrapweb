      ...
      <div class="logo-area">
          <div class="row align-items-center">
            <div class="logo col-lg-3 text-center text-lg-left mb-3 mb-md-5 mb-lg-0">
                <a class="d-block" href="inicio.php">
                  <img loading="lazy" src="images/logo-web.png" alt="Tu Oficina Online Logo">
                </a>
            </div><!-- logo end -->
  <!-- Topinfo telefonos sucursales -->
            <div class="col-lg-9 header-right">
                <ul class="top-info-box">
                  ...
                  <!-- end parte copiada -->
                </ul><!-- Ul end --><!-- END Topinfo telefonos sucursales -->
