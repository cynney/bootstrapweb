<?php include 'php_includes/header.php'; ?><!--/ Aqui estaba el bloque header -->
<body>
  <div class="body-inner">
          ...
          <div class="row">
              <div class="col-lg-8 col-md-8">
                <ul class="top-info text-center text-md-left">
                    <li><i class="fas fa-map-marker-alt"></i> <p class="info-text">Tu OficinaOnline</p>
                    </li>
                </ul>
              </div>
              <!--/ Top info end -->
              ...
              <div class="col-lg-4 col-md-4 top-social text-center text-md-right">
                <ul class="list-unstyled">
                    <li>
                      <a title="Facebook" href="https://www.facebook.com/tuoficinaonline.cl">
                          <span class="social-icon"><i class="fab fa-facebook-f"></i></span>
                      </a>
                    
                      <a title="Instagram" href="https://www.instagram.com/tuoficinaonline.cl">
    ...
    <!--/ Topbar end -->
<?php include 'php_includes/nav.php'; ?> \<!--/ aqui estaba el bloque header/nav -->
...
<!--/ News end -->
  ...
  <?php include 'php_includes/footer.php'; ?><!--/ Aqui estaba el footer y los script -->
  </body>
